...
<head>
    ...
    <script src="src/javascript/reposteria.js"></script> 
    <style>
        .alert-message {
            display: none;
            color: #d9534f;
        ...
        /* Estilos para centrar el modal y bajarlo un poco */
        .modal-dialog {
            margin: 50px auto; /* Asegura que el modal esté centrado y le da un margen superior de 50px */
        }
    </style>
</head>
<body>
    ...
    <div class="container mt-4">
        <h2 class="text-center mb-4">Productos para Cocinar</h2>
        <div class="row">
